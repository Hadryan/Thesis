...
To solve these tasks, we developed ideas that not only result in better ``product'', i.e better performance in terms of prediction outcomes, but also better learning ``process'', i.e better models that are able to extract valuable cues from imperfect signals and capture key aspects of the task at hand.
