...
%
\begin{quote}
\todo{find a nice quote related to the whole thesis! this is not for every chapter, it's just for intro.}
\end{quote}
%
\todo{instance --> sample, all over the thesis}
\todo{example --> sample, all over the thesis}
\todo{book --> thesis, all over the thesis}
...
\todo{talking about tasks: language understanding (as a main cognitive ability): Chomsky stuff, sapphire whorf hypothesis, concrete examples on what we can learn actually which is in fact language understanding. complex questions to abstract concepts. memorizing vs actually modeling relation. Ray Jackendoff stuff.}
...
%maybe move this paragraph to conclusion?
