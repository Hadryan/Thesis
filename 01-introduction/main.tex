...
%
\begin{quote}
\todo{maybe a nice quote?}
\end{quote}
%
Human can effortlessly learn to solve complex real-world problems and learn new concepts from only limited, noisy or variant observations and routinely draw successful generalization on them. 
Even a human child is capable of uncovering the underlying concepts, relations, and structure of sparsely observed events and use that knowledge to go far beyond the paucity of the data.
...
%
However, capturing such human-level learning abilities, given imperfect supervisions, in machines remains a fundamental challenge~\citep{lake2017building} in many domains.
...
\medskip
%maybe move this paragraph to the conclusion?
