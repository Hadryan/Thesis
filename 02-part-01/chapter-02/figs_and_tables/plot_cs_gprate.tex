...
\legend{Biased rating behavior, Neutral rating behavior}
\end{axis}
\end{tikzpicture}
\caption{\label{fig:gprates}Improvement of the performance of contextual suggestion using group profiles for users with different rating behavior.}
    \end{figure}