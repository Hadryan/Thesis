\newcommand{\resqcontent}[1]{%
    ...
    % -------------chapter 4-------------
    {c4}{How to train neural networks using pragmatically generated pseudo-labels as the weak supervision signal, in a way that they exhibit superior generalization capabilities?}%
    %
