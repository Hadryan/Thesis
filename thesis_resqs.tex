\newcommand{\resqcontent}[1]{%
    \IfEqCase{#1}{%
    % -------------MAIN I-------------
    {main}{How can we improve the learning process for language understanding tasks when the supervision signal, i.e., data and/or labels, is of noisy quality or limited quantity?}
    % -------------PART I-------------
