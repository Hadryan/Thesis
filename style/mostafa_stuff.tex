...
\let\endproof\relax
\usepackage{amsthm}
\newtheorem{mydef}{\textbf{\textsc{Definition}}}[chapter]
...
\usepackage[htt]{hyphenat} % long texttt to break

\renewcommand{\texttt}[1]{{\fontsize{10}{11}\fontfamily{pcr}\selectfont{#1}}}

% \renewcommand{\url}[1]{{\fontfamily{pcr}\tt{\url{#1}}}}
...
\newcommand{\feedones}{dense vector representations\xspace}
\newcommand{\feedtwos}{sparse vector representations\xspace}
\newcommand{\feedthrees}{embedding vector representations\xspace}
...
\setlength\LabelSize{\dimexpr\textheight/8
%\totvalue{chapter}
\relax}
