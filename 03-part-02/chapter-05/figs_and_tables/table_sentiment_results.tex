\begin{table}[!t]
            ...
            \pssmall{i} indicates that the improvements with respect to baseline $i$ are statistically significant at the 0.05 level using the paired two-tailed t-test with Bonferroni correction.}
