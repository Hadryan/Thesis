...
%
\begin{quote}
In many applications with scarce training data, we can provide supervision signals for learning algorithms by pseudo-labeling the data programmatically, rather by hand. This way, we can generate a much larger training set with low cost. However, we need to design algorithms that are capable of learning from weakly annotated labels and of going beyond the imperfection in pseudo-labels. 
\end{quote}
%
